...
def initialize_centroids():
    ...
    centroids.append(Centroid(SAMPLES[7][0], SAMPLES[7][1]))
    centroids.append(Centroid(SAMPLES[9][0], SAMPLES[9][1]))
    centroids.append(Centroid(SAMPLES[10][0], SAMPLES[10][1]))
...
def update_clusters():
    ...
    isStillMoving -=1
    print("istillingmoveing"+str(isStillMoving))
    for i in range(TOTAL_DATA):
